...
TELEGRAM_API = int(TELEGRAM_API) if len(TELEGRAM_API) != 0 else ""

TELEGRAM_HASH = environ.get("TELEGRAM_HASH", "")
TELEGRAM_HASH = TELEGRAM_HASH if len(TELEGRAM_HASH) == 0 else TELEGRAM_HASH
